...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light bg-light">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">RSIA Aisyiyah</a>
        <!-- Sidebar Toggle-->
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Made by <b>MN Dev</b> with <i class="fa fa-heart text-danger" aria-hidden="true"></i> to <b>RSIA Aisyiyah Bangkalan</b></div>
                        <div>
                        </div>
                    </div>
                </div>
