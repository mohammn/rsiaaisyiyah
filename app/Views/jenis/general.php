            ...
            <table class="table table-striped table-responsive-lg" id="tabelRm">
                ...
                <tbody id="tabelDataRm">
                    <tr>
                        ...
                        <td><?= !empty($data->persRajal['ttdWali']) && !empty($data->persRajal['ttdSaksi']) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                        <td>
