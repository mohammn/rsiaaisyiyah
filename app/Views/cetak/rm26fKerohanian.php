            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p style="font-size: 14pt; margin:10px;" class="text-uppercase fw-bold"> PERMINTAAN PELAYANAN KEROHANIAN
                        </p>
                    </div>
                </div>
                ...
                <table class="table table-borderless table-sm mt-2">
                    <tr>
                        ...
                        <td>: <?= $data->rm26fKerohanian['nama'] ?? '' ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>: <?= $data->rm26fKerohanian['jk'] == 'L' ? 'Laki-laki' : 'Perempuan' ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                ...
                <br>
                Meminta kepada Rumah Sakit Ibu dan Anak Aisyiyah untuk dapat menyediakan pelayanan kerohanian kepada :
                <table class="table table-sm table-borderless mt-2">
                    ...
                    <?php
                    $waktuKeluarStr = $data->rm26fKerohanian["waktu"] ?? '';
                    ...
                    <tr>
                        <td>Waktu</td>
                        <td>: <?= $hariTanggal . ', Jam : ' . $pukul . ' WIB.' ?></td>
                    </tr>
                    <tr>
                ...
                Demikian permintaan ini saya buat dengan penuh kesadaran dan tanpa paksaan.

                <br><br>
                <div class="row text-center mt-1">
                    <div class="col-12 text-end pe-5">
                        Bangkalan, <?= $data->rm26fKerohanian['tglTtd'] ?>
                    </div>
                    <table class="table table-borderless">
                        <tr class="text-center" style="margin:auto;">
                            <td>
                                ...
                                <div id="ttdWali">
                                    <?php if ($data->rm26fKerohanian["ttdWali"]) {
                                        ...
                                        echo '<img src="' . base_url('public/ttd/rm26fKerohanian/' . $data->rm26fKerohanian["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                    } else {
                                        echo '<br><br><br><br><br>';
                                    } ?>
                                </div>
                                <br>
                                (<?= $data->rm26fKerohanian["nama"] ?> )
                                <br><br>
                                <?php if (!$data->rm26fKerohanian["ttdWali"]) { ?>
                            ...
                            <td>
                                ...
                                <br>
                                (<?= $data->rm26fKerohanian["petugas"] ?> )
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" id="noRawat" value="<?= $data->rm26fKerohanian["noRawat"] ?>">
                    <input type="hidden" id="petugas" value="<?= $data->rm26fKerohanian["petugas"] ?>">
                    <div class="row mt-2">
                        <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/rm26fKerohanian/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
