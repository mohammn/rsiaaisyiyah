            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center mt-2">
                        <h5><b>PERSETUJUAN UMUM RAWAT JALAN</b></h5>
                    </div>
                </div>
        ...
        <div class="page">
            <div class="subpage">
                ...
                <ol type="A" start="2" class="parent-ol">
                            ...
                            <li>
                                ...
                                <ol type="a">
                                    ...
                                    <li>
                                        ...
                                        <ol type="1">
                                            <?php
                                            $dataKeluarga = explode(",", $data->persetujuanRajal["keluarga"]);
                    ...
                    <li>
                        <b>PEMBAYARAN</b> <br>
                        <?= strtoupper($data->persetujuanRajal["pembayaran"]) ?>
                ...
                <table class="table table-borderless mt-5">
                    <tr>
                        <td colspan="3" class="text-end pe-5">Bangkalan, <?= $data->persetujuanRajal["tglTtd"] ?></td>
                    </tr>
                    <tr class="text-center" style="margin:auto;">
                        <td>
                            ...
                            <br>
                            (<?= $data->persetujuanRajal["petugas"] ?> )
                        </td>
                        <td>
                            Saksi
                            <br><br>
                            <div id="ttdSaksi">
                                <?php if (!empty($data->persetujuanRajal["ttdSaksi"]) && $data->persetujuanRajal["selesai"] == "1") {
                                    // SOLUSI: Menggunakan base_url() murni yang digabung dengan string path
                                    $urlSaksi = base_url() . 'public/ttd/persRajal/' . $data->persetujuanRajal["ttdSaksi"];
                        ...
                        <td>
                            ...
                            <div id="ttdWali">
                                <?php if ($data->persetujuanRajal["selesai"] && !empty($data->persetujuanRajal["ttdWali"])) {
                                    // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                    echo '<img src="' . base_url('public/ttd/persRajal/' . $data->persetujuanRajal["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                } else {
                                    echo '<br><br><br><br><br><br>';
                                } ?>
                            </div>
                            <br>
                            (<?= $data->persetujuanRajal["nama"] ?> )
                            <br><br>
                            <?php if (!$data->persetujuanRajal["selesai"]) { ?>
                ...
                <input type="hidden" id="noRm" value="<?= $data->persetujuanRajal["noRm"] ?>">
                <input type="hidden" id="petugas" value="<?= $data->persetujuanRajal["petugas"] ?>">
                <div class="row mt-5">
                    <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/persetujuanRajal/simpanTtd',
            method: 'post',
            data: {
                noRm: noRm,
                ttdSaksi: ttdSaksi,
