                ...
                <table class="table table-bordered table-sm">
                    <tr class="text-center">
                        <th style="background-color: #eaeaea;" colspan="4">
                            <p style="font-size: 14pt; margin:0;" class="text-uppercase"><i><b>INFORMED CONSENT </b></i> TINDAKAN PEMBIUSAN <br>
                                (ANESTESI REGIONAL, UMUM/ SEDASI)
                            </p>
                        </th>
                    </tr>
                    <tr class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="vertical-align: top; font-size: 0.9rem;">
                            ...
                            <div class="text-muted" style="font-size: 7pt;">( <?= $data->icPembiusan['nama'] ? $data->icPembiusan['nama'] : '............................' ?> )</div>
                        </td>
                    </tr>
                    ...
                    <div class="card p-5 border-dark shadow-sm">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-8 d-flex align-items-center">
                                    <span class="me-2">:</span>
                                    <?= $data->icPembiusan["tempatLahir"] . ", " . $tglLahir->format('d-m-Y')  ?></td>
                                    <span class="ms-3">/ <?= $data->icPembiusan["jk"] == "L" ? 'LAKI - LAKI' : ' PEREMPUAN' ?></span>
                                </div>
                            </div>
                        ...
                        <div class="mb-2">
                            <div class="row mb-1">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <?= $data->icPembiusan['tindakanMedis'] ?>
                                </div>
                            </div>

                            <p class="mb-3 fw-bold">Terhadap : <?= $data->icPembiusan['sebagai'] ?></p>
                        ...
                        <div class="row text-center mt-1">
                            <div class="col-12 text-end">
                                Bangkalan, <?= $data->icPembiusan['tglTtd'] ?>
                            </div>
                            <table class="table table-borderless">
                                <tr class="text-center" style="margin:auto;">
                                    <td>
                                        ...
                                        <br>
                                        (<?= $data->icPembiusan["dokter"] ?> )
                                    </td>
                                    <td>
                                        Saksi
                                        <br><br>
                                        <div id="ttdSaksi">
                                            <?php if ($data->icPembiusan["ttdSaksi"]) {
                                                // SOLUSI: Menggunakan base_url() murni yang digabung dengan string path
                                                $urlSaksi = base_url() . 'public/ttd/icPembiusan/' . $data->icPembiusan["ttdSaksi"];
                                    ...
                                    <td>
                                        ...
                                        <div id="ttdWali">
                                            <?php if ($data->icPembiusan["ttdWali"]) {
                                                // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                                echo '<img src="' . base_url('public/ttd/icPembiusan/' . $data->icPembiusan["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                            } else {
                                                echo '<br><br><br><br><br>';
                                            } ?>
                                        </div>
