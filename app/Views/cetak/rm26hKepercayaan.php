...
<head>
    ...
    <title>Cetak Nilai-nilai Kepercayaan</title>
            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p style="font-size: 14pt; margin:10px;" class="text-uppercase fw-bold">IDENTIFIKASI NILAI – NILAI DAN KEPERCAYAAN PASIEN
                        </p>
                    </div>
                </div>
                ...
                <table class="table table-borderless table-sm mt-2">
                    <tr>
                        ...
                        <td>: <?= $data->rm26hKepercayaan['nama'] ?? '' ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>: <?= $data->rm26hKepercayaan['jk'] == 'L' ? 'Laki-laki' : 'Perempuan' ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                ...
                <br>
                Adalah <b><?= $data->rm26hKepercayaan["sebagai"] ?? '' ?></b> dari pasen :
                ...
                <br>
                Dengan ini memohon kepada petugas Rumah Sakit Ibu dan Anak Aisyiyah agar tidak memberikan
                terapi atau melakukan tindakan terhadap saya/pasien yang bertentangan dengan nilai – nilai atau
                kepercayaan saya/ pasien.

                Adapaun hal – hal yang bertentangan dengan nilai – nilai dan kepercayaan saya/ pasien adalah sebagai
                berikut:
                <div class="p-3">
                    <?= nl2br(esc($data->rm26hKepercayaan["nilaiKepercayaan"])) ?>
                </div>
                Demikianlah permohonan ini saya sampaikan.
                <br><br>
                <div class="row text-center mt-1">
                    <div class="col-12 text-end pe-5">
                        Bangkalan, <?= $data->rm26hKepercayaan['tglTtd'] ?>
                    </div>
                            ...
                            <td style="width:40%;">
                                ...
                                <div id="ttdWali">
                                    <?php if ($data->rm26hKepercayaan["ttdWali"]) {
                                        ...
                                        echo '<img src="' . base_url('public/ttd/rm26hKepercayaan/' . $data->rm26hKepercayaan["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                    } else {
                                        echo '<br><br><br><br><br>';
                                    } ?>
                                </div>
                                <br>
                                (<?= $data->rm26hKepercayaan["nama"] ?> )
                                <br><br>
                                <?php if (!$data->rm26hKepercayaan["ttdWali"]) { ?>
                    ...
                    <input type="hidden" id="noRawat" value="<?= $data->rm26hKepercayaan["noRawat"] ?>">
                    <input type="hidden" id="petugas" value="<?= $data->rm26hKepercayaan["petugas"] ?>">
                    <div class="row mt-2">
                        <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/rm26hKepercayaan/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
