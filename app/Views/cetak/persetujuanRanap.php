...
<head>
    ...
    <title>Cetak Persetujuan Rawat Inap</title>
    ...
    <div class="book">
            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center mt-2">
                        <h5><b>PERSETUJUAN UMUM RAWAT INAP</b></h5>
                    </div>
                </div>
        ...
        <div class="page">
            <div class="subpage">
                ...
                <ol type="A" start="2" class="parent-ol">
                    ...
                    <li>
                        <b>PEMILIHAN DPJP. </b>
                        Saya telah menerima dan memahami informasi mengenai dokter penanggung jawab pasien
                        selama dirawat Rumah Sakit, maka saya memilih Dokter : <b><u> <?= $data->persetujuanRanap["dokter"] ?> </u></b> Sebagai dokter penanggung
                        jawab. <br><br>
                    </li>
                    <li>
                            ...
                            <li>
                                ...
                                <ol type="a">
                                    ...
                                    <li>
                                        ...
                                        <ol type="1">
                                            <?php
                                            $dataKeluarga = explode(",", $data->persetujuanRanap["namaKeluarga"]);
                    ...
                    <li>
                        ...
                        <br>Saya menyatakan bahwa saya telah menerima informasi tentang adanya tatacara mengajukan dan mengatasi
                        keluhan terkait pelayanan yang diberikan kepada saya. Saya setuju untuk mengikuti tatacara tersebut sesuai
                        dengan prosedur yang ada.
                        <br><br>
                    </li>
                    <li>
                        <b>PRIVASI</b><br>
                        Saya memberi kuasa kepada Rumah Sakit Ibu dan Anak Aisyiyah untuk menjaga privasi dan kerahasian penyakit
                        saya selama dalam perawatan: <br>
                        <b>
                            <?php if ($data->persetujuanRanap["izin_jenguk"] === 'semua'): ?>
                                Saya mengijinkan semua orang menjenguk saya.
                            <?php elseif ($data->persetujuanRanap["izin_jenguk"] === 'kecuali'): ?>
                                Saya mengijinkan semua orang menjenguk saya, kecuali: <u><?= $data->persetujuanRanap["isi_kecuali"] ?></u>
                            <?php else: ?>
                                Saya tidak mengijinkan semua orang menjenguk saya, kecuali: <u><?= $data->persetujuanRanap["isi_kecuali"] ?></u>
                            <?php endif; ?>
                        </b>
                        <br><br>
                    </li>
                    <li>
                        ...
                        Saya telah memahami bahwa rumah sakit telah menghimbau kepada saya untuk tidak membawa barang berharga serta
                        rumah sakit tidak bertanggung jawab atas semua kehilangan barang-barang milik saya dan saya secara pribadi
                        bertanggung jawab atas barang-barang berharga yang saya miliki namun tidak terbatas pada uang, perhiasan, buku cek,
                        kartu kredit, handphone atau barang lainnya. Dan apabila saya membutuhkan maka saya dapat menitipkan barang barang
        ...
        <div class="page">
            <div class="subpage">
                ...
                <ol type="A" start="9" class="parent-ol">
                    <li>
                        <b>KEWAJIBAN PEMBAYARAN</b> <br>
                        <ol>
                            <li>
                                Menjadi pasien dengan status sebagai : <br>
                                <?php if ($data->persetujuanRanap["jenis_pasien"] === 'umum'): ?>
                                    <b>PASIEN UMUM :</b>
                                    <?php if ($data->persetujuanRanap["status_asuransi_umum"] === 'menolak'): ?>
                                        karena dengan sadar menolak menggunakan Asuransi.
                                    <?php else: ?>
                                        karena tidak mempunyai asuransi.
                                    <?php endif; ?>
                                    <br>
                                    <u>Permintaan Kelas :</u> <?= $data->persetujuanRanap["kelas_umum"] === 'lainnya' ? $data->persetujuanRanap["kelas_umum_lain_text"] : $data->persetujuanRanap["kelas_umum"] ?>
                                    <br>Dengan perkiraan biaya
                                    Rp. <?= is_numeric($data->persetujuanRanap["biaya_min"] ?? null) ? number_format($data->persetujuanRanap["biaya_min"], 0, ',', '.') : '0' ?>
                                    s/d
                                    Rp. <?= is_numeric($data->persetujuanRanap["biaya_max"] ?? null) ? number_format($data->persetujuanRanap["biaya_max"], 0, ',', '.') : '0' ?>.
                                    <br>
                                    Saya bertanggungjawab untuk membayar semua biaya yang timbul selama perawatan pasien dan dibayar lunas
                                    pada saat pasien selesai perawatan (pada saat pulang).
                                <?php elseif ($data->persetujuanRanap["jenis_pasien"] === 'bpjs'): ?>
                                    <b>PASIEN BPJS KESEHATAN.</b> dengan nomor identitas BPJS KESEHATAN/JKN: <b><u><?= $data->persetujuanRanap["no_bpjs"] ?></u></b> <br>
                                    <?php if ($data->persetujuanRanap["bpjs_status_kelas"] === 'tidak_naik'): ?>
                                        Permintaan Kelas :
                                        <u><b>TIDAK NAIK KELAS</b></u>
                                    <?php else: ?>
                                        Permintaan Kelas :
                                        <u><b>NAIK KELAS PERAWATAN</b></u> <br>

                                        <b>Status kenaikan kelas :</b>
                                        <?php if ($data->persetujuanRanap["bpjs_naik_tingkat"] === '1_atau_2'): ?>
                                            1 tingkat / 2 tingkat. bersedia membayar selisih biaya berdasarkan selisih tarif INACBGS*)
                                            dan tidak mendapatkan print rincian biaya, dikarenakan untuk klaim ke BPJS.
                                        <?php else: ?>
                                            Kelas 3 yang berdasrkan ketentuan BPJS Kesehatan tidak diperkenankan melakukan peningkatan
                                            kelas perawatan, <b>JIKA NAIK KELAS</b> maka secara otomatis kepesertaan BPJS dianggap gugur dan
                                            dinyatakan sebagai pasien umum dan bersedia membayar biaya perawatan
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            Apabila sampai waktu yang telah ditentukan, saya tidak dapat menunjukkan kartu identitas peserta JKN dan
                                            atau SEP tidak bisa dicetak karena kartu tidak aktif maka pasien dinyatakan sebagai PASIEN UMUM dan
                                            tidak dapat dijamin BPJS kesehatan.
                                        </li>
                                    </ul>
                                <?php else: ?>
                                    <b>PASIEN ASURANSI LAIN</b>. (Sebutkan) : <?= $data->persetujuanRanap["nama_asuransi_lain"] ?>
                                    <ul>
                                        <li>
                                            Apabila pasien/keluarga memilih kelas yang lebih tinggi dari haknya, maka selisih dari seluruh biaya
                                            perawatan, obat, pengunjung medis, jasa dokter, ditanggung oleh pasien/keluarga pasien dan dibayar
                                            lunas pada saat pasien selesai perawatan (pada saat pulang)
                                        </li>
                                        <li>
                                            Khusus untuk asuransi JASARAHARJA wajib menunjukkan surat keterangan kecelakaan dari kepolisian
                                            maksimal 1 x 24 jam sejak kejadian. Jika tidak, maka dianggap pasien umum.
                                        </li>
                                        <li>
                                            Apabila dalam proses perawatan, ternyata instansi/asuransi tidak menanggung pembiayaan maka seluruh
                                            biaya perawatan pasien ditanggung oleh pasien/keluarga.
                                        </li>
                                    </ul>
                                <?php endif; ?>
                            </li>
                            <li>
                                <b>Tidak akan mengganti</b> status penjamin pasien selama dirawat di Rumah Sakit.
                            </li>
                            <li>
                                Menyetujui peraturan tentang perpindahan pasien pasca tindakan/operasi ke kelas yang lebih tinggi
                                <ul>
                                    <li>
                                        Apabila perpindahan kelas dilakukan sebelum 3 x 24 jam pasca operasi, maka perhitungan seluruh biaya
                                        akan dikenakan tarif kelas tertinggi yang ditempati.
                                    </li>
                                    <li>
                                        Apabila perpindahan kelas diajukan setelah 3 x 24 jam pasca operasi, maka biaya operasi dan biaya
                                        tindakan yang terjadi sebelum perpindahan kelas akan dihitung sesuai dengan kelas yang ditempati saat
                                        dilakukan tindakan/operasi.
                                    </li>
                                </ul>
                            </li>
                            <li>
                                Waktu pulang (check out) Pulang diatas pukul 19.00 WIB : dikenakan tambahan biaya kamar 100% (satu hari)
                            </li>
                        </ol>
                        <br>
                    </li>
                    <li>
                        <b>SAYA JUGA MENYADARI DAN MEMAHAMI BAHWA</b>
                        <ol type="a">
                            <li>
                                ...
                                bertanggung jawab untuk membayar semua pelayanan dan tindakan medis dari Rumah Sakit Ibu dan Anak
                                Aisyiyah.
                            </li>
                            <li>
                ...
                <table class="table table-borderless mt-5">
                    <tr>
                        <td colspan="3" class="text-end pe-5">Bangkalan, <?= $data->persetujuanRanap["tglTtd"] ?></td>
                    </tr>
                    <tr class="text-center" style="margin:auto;">
                        <td>
                            ...
                            <br>
                            (<?= $data->persetujuanRanap["petugas"] ?> )
                        </td>
                        <td>
                            Saksi
                            <br><br>
                            <div id="ttdSaksi">
                                <?php if ($data->persetujuanRanap["ttdSaksi"]) {
                                    // SOLUSI: Menggunakan base_url() murni yang digabung dengan string path
                                    $urlSaksi = base_url() . 'public/ttd/persetujuanRanap/' . $data->persetujuanRanap["ttdSaksi"];
                        ...
                        <td>
                            ...
                            <div id="ttdWali">
                                <?php if ($data->persetujuanRanap["ttdWali"]) {
                                    // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                    echo '<img src="' . base_url('public/ttd/persetujuanRanap/' . $data->persetujuanRanap["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                } else {
                                    echo '<br><br><br><br><br><br>';
                                } ?>
                            </div>
                            <br>
                            (<?= $data->persetujuanRanap["namaWali"] ?> )
                            <br><br>
                            <?php if (!$data->persetujuanRanap["ttdWali"]) { ?>
                ...
                <input type="hidden" id="noRawat" value="<?= $data->persetujuanRanap["noRawat"] ?>">
                <input type="hidden" id="petugas" value="<?= $data->persetujuanRanap["petugas"] ?>">
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <div class="" id="pesanError"></div>
                        <?php if (!$data->persetujuanRanap["ttdWali"] and !$data->persetujuanRanap["ttdSaksi"]) { ?>
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/persetujuanRanap/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdSaksi: ttdSaksi,
    ...
    qrcode.makeCode("Di tanda tangani oleh " + $("#petugas").val() + " untuk Persetujuan Rawat Jalan. No RM : " + $("#noRawat").val()); // Replace with your desired text or URL
