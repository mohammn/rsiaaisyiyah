...
$tgl_skrining = $data->tbIbu["tglSkrining"] ?? null;
            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p style="font-size: 14pt; margin:10px;" class="text-uppercase fw-bold">
                            FORMULIR SKRINING TBC UNTUK USIA &ge; 15 TAHUN
                        </p>
                    </div>
                </div>
                ...
                <table class="table table-sm table-bordered table-padding-minimal mb-0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">: <?= $data->tbIbu["tglSkrining"] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td>Tempat Skrining</td>
                        <td colspan="3">: <?= $data->tbIbu["tempatSkrining"] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td>Nama</td>
                    ...
                    <tr>
                        <?php if ($usia > 18): ?>
                            <th colspan="4" class="text-center bg-success">Usia &gt; 18 tahun: Perhitungan IMT untuk usia diatas 18 tahun</th>
                        <?php else: ?>
                            <th colspan="4" class="text-center bg-success">Usia 15-18 tahun: IMT/U</th>
                        <?php endif; ?>
                    </tr>
                    <tr>
                        <td>Berat Badan <?= $data->tbIbu["beratBadan"] ?? '....' ?> Kg</td>
                        <td>Tinggi/Panjang Badan <?= $data->tbIbu["tinggiBadan"] ?? '....' ?> Cm</td>
                        <td colspan="2">
                            <?php if ($usia > 18): ?>
                                IMT <?= $data->tbIbu["tinggiBadan"] ?? '....' ?> Kg/M<sup>2</sup>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->tbIbu['kurangGizi'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Merokok</td>
                        <td colspan="2"><?= $data->tbIbu['merokok'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Perokok Pasif</td>
                        <td colspan="2"><?= $data->tbIbu['perokokPasif'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Riwayat DM/Kencing Manis</td>
                        <td colspan="2"><?= $data->tbIbu['kencingManis'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">ODHIV</td>
                        <td colspan="2"><?= $data->tbIbu['odhiv'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Lansia &gt; 65 Tahun</td>
                        <td colspan="2"><?= $data->tbIbu['lansia'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Ibu Hamil</td>
                        <td colspan="2"><?= $data->tbIbu['ibuHamil'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Warga Binaan Pemasyarakatan (WBP)</td>
                        <td colspan="2"><?= $data->tbIbu['wbp'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Jika WBP, tanggal masuk lapas/rutan</td>
                        <td colspan="2"><?= $data->tbIbu['tglWbp'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Jika WBP, status WBP nya adalah</td>
                        <td colspan="2"><?= $data->tbIbu['statusWbp'] ?? '-' ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">Tinggal di wilayah padat kumuh miskin</td>
                        <td colspan="2"><?= $data->tbIbu['kumuh'] ?? '-' ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->tbIbu['getahBening'] ?? '-' ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->tbIbu['posit'] ?? '-' ?></td>
                    </tr>
                    <tr>
                ...
                <div>
                    ...
                    <b>Dikatakan Pemeriksaan TBC Laten "Tidak", jika:</b>
                    <ul class="mb-0">
                        <li>Dikatakan sebagai terduga TBC atau</li>
                        <li>ODHIV (Diberikan)</li>
                    </ul>
                </div>
                ...
                <div class="row text-center mt-1">
                    <table class="table table-borderless">
                        <tr class="text-center" style="margin:auto;">
                            ...
                            <td>
                                ...
                                <div id="ttdWali">
                                    <?php if ($data->tbIbu["ttdWali"]) {
                                        // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                        echo '<img src="' . base_url('public/ttd/tbIbu/' . $data->tbIbu["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                    } else {
                                        echo '<br><br><br><br><br>';
                                    } ?>
                                </div>
                    ...
                    <input type="hidden" id="noRawat" value="<?= $data->tbIbu["noRawat"] ?>">
                    <input type="hidden" id="petugas" value="<?= $data->tbIbu["petugas"] ?>">
                    <div class="row mt-2">
                        <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/tbIbu/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
