            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center mt-2">
                        <br>
                        <p style="font-size: 14pt;"><b>FORMULIR PEMILIHAN DPJP <br>
                                (DOKTER PENANGGUNG JAWAB PASIEN) <br>
                                RAWAT INAP</b></p>
                    </div>
                </div>
                <b>Yang bertanda tangan dibawah ini :</b><br><br>
                <table class="table table-borderless w-70 tabel">
                    <tr>
                        <td style="width: 20%;">Nama</td>
                        <td>: <?= $data->dpjp["nama"] ?></td>
                    </tr>
                    <tr>
                        <td>Jenis Kelamin </td>
                        <td>: <?= $data->dpjp["jk"] == "L" ? 'LAKI - LAKI' : ' PEREMPUAN' ?></td>
                    </tr>
                    <tr>
                        <td>TTL/Umur </td>
                ...
                <b>Bertindak sebagai <?= $data->dpjp["sebagai"] ?> dari pasien : </b> <br><br>
                <table class="table table-borderless  w-70 tabel">
                    <tr>
                        <td style="width: 20%;">Nama</td>
                        <td>: <?= $data->pasien["nm_pasien"] ?></td>
                    ...
                    <tr>
                        <td>TTL / Umur</td>
                        <td>: <?= $data->pasien["tmp_lahir"] . ", " . $tglLahirPasien->format('d-m-Y') . " / " . $today->diff($tglLahirPasien)->y ?></td>
                    </tr>
                </table>
                Dengan ini menyatakan dengan sadar dan sesungguhnya bahwa : <br><br>
                <ol style="line-height: 1.8;">
                    <li>
                        Telah menerima dan memahami informasi mengenai dokter penanggung jawab pasien selama dirawat di Rumah Sakit Ibu dan Anak Aisyiyah
                    </li>
                    <li>
                        Berdasarkan hal tersebut diatas saya memilih dokter berikut sebagai Dokter Penanggung Jawab : <br> <u><b><?= $data->dpjp["dokter"] ?></b></u>
                ...
                <table class="table table-borderless mt-5">
                    <tr>
                        <td colspan="3" class="text-end pe-5">Bangkalan, <?= $data->dpjp["tglTtd"] ?></td>
                    </tr>
                    <tr class="text-center" style="margin:auto;">
                        ...
                        <td>
                            ...
                            <div id="ttdWali">
                                <?php if (!empty($data->dpjp["ttdWali"])) {
                                    // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                    echo '<img src="' . base_url('public/ttd/dpjp/' . $data->dpjp["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                } else {
                ...
                <input type="hidden" id="noRawat" value="<?= $data->dpjp["noRawat"] ?>">
                <input type="hidden" id="petugas" value="<?= $data->dpjp["petugas"] ?>">
                <div class="row mt-5">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/dpjp/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
