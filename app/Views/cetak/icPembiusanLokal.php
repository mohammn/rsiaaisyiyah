                ...
                <table class="table table-bordered table-sm">
                    <tr class="text-center">
                        <th style="background-color: #eaeaea;" colspan="4">
                            <p style="font-size: 14pt; margin:0;" class="text-uppercase"><i><b>INFORMED CONSENT </b></i> TINDAKAN PEMBIUSAN (ANESTESI LOKAL)
                            </p>
                        </th>
                    </tr>
                    <tr class="text-center">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->icPembiusanLokal['dokter'] ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->icPembiusanLokal['nama'] ?></td>
                    </tr>
                    <tr class="text-center">
                        <th>No.</th>
                    ...
                    <tr>
                        ...
                        <td style="width: 15%;">Diagnosis (WD & DD)</td>
                        <td style="width: 80%;">
                            <?= $data->icPembiusanLokal['diagnosis'] ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            Anestesi dengan anestesi permukaan, infiltrasi
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            Untuk operasi pada perawatan atau pencabutan gigi,
                            ganglion, lipoma, fibroma, sirkumsisi dan lain – lain.
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>Tata cara</td>
                        <td>
                            Infiltrasi :desinfeksi area, suntikan di area.
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>Tujuan</td>
                        <td>
                            Menghilangkan rasa sakit pada sebagian tubuh dan
                            pasien tetap dalam kondisi sadar
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Komplikasi</td>
                        <td>
                            Depresi atau stimulasi pada sistem saraf pusat, infeksi
                            dan jantung.
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>Prognosis</td>
                        <td>
                            <?= $data->icPembiusanLokal['prognosis'] ?>
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?= $data->icPembiusanLokal['alternatif'] ?>
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td>Lain - lain</td>
                        <td>
                            <?= $data->icPembiusanLokal['lainLain'] ?>
                        </td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center" style="vertical-align: top; font-size: 0.9rem;">
                            ...
                            <div class="text-muted" style="font-size: 7pt;">( <?= $data->icPembiusanLokal['dokter'] ? $data->icPembiusanLokal['dokter'] : '............................' ?> )</div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" class="p-1" style="vertical-align: top; height: 100px;">
                        ...
                        <td class="text-center" style="vertical-align: top; font-size: 0.9rem;">
                            ...
                            <?php if ($data->icPembiusanLokal["ttdWali"]) {
                                // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                echo '<img src="' . base_url('public/ttd/icPembiusanLokal/' . $data->icPembiusanLokal["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 50px;" data-is-new="false">';
                            } else {
                                echo '<br><br>';
                            } ?>
                            <div class="text-muted" style="font-size: 7pt;">( <?= $data->icPembiusanLokal['nama'] ? $data->icPembiusanLokal['nama'] : '............................' ?> )</div>
                        </td>
                    </tr>
                ...
                <div class="container my-4 text-dark" style="max-width: 800px; font-family: 'Times New Roman', Times, serif; line-height: 1.6;">
                    <div class="card p-5 border-dark shadow-sm">
                        ...
                        <div class="text-center mb-1">
                            <p style="font-size: 14pt;"><b><?= $data->icPembiusanLokal['jenis'] ?> TINDAKAN KEDOKTERAN</b></p>
                        </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-8 d-flex align-items-center">
                                    <span class="me-2">:</span>
                                    <?= $data->icPembiusanLokal["tempatLahir"] . ", " . $tglLahir->format('d-m-Y')  ?></td>
                                    <span class="ms-3">/ <?= $data->icPembiusanLokal["jk"] == "L" ? 'LAKI - LAKI' : ' PEREMPUAN' ?></span>
                                </div>
                            </div>
                        ...
                        <div class="text-center mb-1">
                            <p style="font-size: 14pt;"><b><?= $data->icPembiusanLokal['jenis'] ?></b></p>
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="row mb-1">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <?= $data->icPembiusanLokal['tindakanMedis'] ?>
                                </div>
                            </div>

                            <p class="mb-3 fw-bold">Terhadap : <?= $data->icPembiusanLokal['sebagai'] ?></p>
                        ...
                        <div class="row text-center mt-1">
                            <div class="col-12 text-end">
                                Bangkalan, <?= $data->icPembiusanLokal['tglTtd'] ?>
                            </div>
                            <table class="table table-borderless">
                                <tr class="text-center" style="margin:auto;">
                                    <td>
                                        ...
                                        <br>
                                        (<?= $data->icPembiusanLokal["dokter"] ?> )
                                    </td>
                                    <td>
                                        Saksi
                                        <br><br>
                                        <div id="ttdSaksi">
                                            <?php if ($data->icPembiusanLokal["ttdSaksi"]) {
                                                // SOLUSI: Menggunakan base_url() murni yang digabung dengan string path
                                                $urlSaksi = base_url() . 'public/ttd/icPembiusanLokal/' . $data->icPembiusanLokal["ttdSaksi"];
                                    ...
                                    <td>
                                        ...
                                        <div id="ttdWali">
                                            <?php if ($data->icPembiusanLokal["ttdWali"]) {
                                                // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                                echo '<img src="' . base_url('public/ttd/icPembiusanLokal/' . $data->icPembiusanLokal["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                            } else {
                                                echo '<br><br><br><br><br>';
                                            } ?>
                                        </div>
                            ...
                            <input type="hidden" id="noRawat" value="<?= $data->icPembiusanLokal["noRawat"] ?>">
                            <input type="hidden" id="dokter" value="<?= $data->icPembiusanLokal["dokter"] ?>">
                            <div class="row mt-2">
                                <div class="col-12 text-center">
                                    <div class="" id="pesanError"></div>
                                    <?php if (!$data->icPembiusanLokal["ttdWali"] and !$data->icPembiusanLokal["ttdSaksi"]) { ?>
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/icPembiusanLokal/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdSaksi: ttdSaksi,
