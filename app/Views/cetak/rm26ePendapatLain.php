...
<head>
    ...
    <title>Cetak Pendapat Lain</title>
        ...
        <div class="page">
            <div class="subpage">
                ...
                <table class="table table-sm mt-2">
                    ...
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>: <?= $data->rm26ePendapatLain['jk'] == 'L' ? 'Laki-laki' : 'Perempuan' ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                ...
                <table class="table table-sm mt-2">
                    ...
                    <tr>
                        <td>Dirawat Dokter</td>
                        <td>: <?= $data->rm26ePendapatLain["dokter"] ?? '' ?></td>
                    </tr>
                    <tr>
                        <td>Diagnosa</td>
                        <td>: <?= $data->rm26ePendapatLain["diagnosa"] ?? '' ?></td>
                    </tr>
                    <tr>
                        <td>Hasil Pemeriksaan</td>
                        <td>: <?= $data->rm26ePendapatLain["hasilPemeriksaan"] ?? '' ?></td>
                    </tr>
                </table>
                ...
                Saya memahami perlunya dan manfaat pendapat lain (<i>second opinion</i>) tersebut sebagaimana telah dijelaskan kepada saya. Saya telah
                mendapatkan kesempatan untuk bertanya dan telah mendapatkan jawaban yang memuaskan. Saya juga menyadari
                bahwa oleh karena ilmu kedokteran bukanlah ilmu pasti dan selalu berkembang, maka perbedaan pendapat ahli adalah
                biasa terjadi dalam dunia kedokteran. Saya menyadari beban biaya pendapat lain (<i>second opinion</i>) menjadi tanggung jawab saya.
                <br><br>
                <div class="row text-center mt-1">
                    <div class="col-12 text-end pe-5">
                        Bangkalan, <?= $data->rm26ePendapatLain['tglTtd'] ?>
                    </div>
                    <table class="table table-borderless">
                        <tr class="text-center" style="margin:auto;">
                            <td>
                                ...
                                <div id="ttdWali">
                                    <?php if ($data->rm26ePendapatLain["ttdWali"]) {
                                        ...
                                        echo '<img src="' . base_url('public/ttd/rm26ePendapatLain/' . $data->rm26ePendapatLain["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                    } else {
                                        echo '<br><br><br><br><br>';
                                    } ?>
                                </div>
                                <br>
                                (<?= $data->rm26ePendapatLain["nama"] ?> )
                                <br><br>
                                <?php if (!$data->rm26ePendapatLain["ttdWali"]) { ?>
                            ...
                            <td>
                                ...
                                <br>
                                (<?= $data->rm26ePendapatLain["dokter"] ?> )
                            </td>
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" id="noRawat" value="<?= $data->rm26ePendapatLain["noRawat"] ?>">
                    <input type="hidden" id="dokter" value="<?= $data->rm26ePendapatLain["dokter"] ?>">
                    <div class="row mt-2">
                        <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/rm26ePendapatLain/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
