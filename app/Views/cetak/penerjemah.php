            ...
            <div class="subpage">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p style="font-size: 14pt; margin:10px;" class="text-uppercase fw-bold"> FORMULIR PERMINTAAN PENERJEMAH
                        </p>
                    </div>
                </div>
                ...
                <table class="table table-sm table-borderless mt-2">
                    ...
                    <tr>
                        <td style="width:30%">Bahasa Pengantar Pasien</td>
                ...
                <table class="table table-sm table-borderless mt-2">
                    ...
                    <tr>
                        <td>Jenis Kelamin</td>
                        <td>: <?= $data->penerjemah['jk'] == 'L' ? 'Laki-laki' : 'Perempuan' ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                ...
                <u><b><?= $data->penerjemah["bahasa"] ?? '....................' ?></b></u> selama pasien mendapatkan perawatan di RSIA ‘Aisyiyah Bangkalan.


                <br><br>
                <div class="row text-center mt-1">
                    <div class="col-12 text-end pe-5">
                        Bangkalan, <?= $data->penerjemah['tglTtd'] ?>
                    </div>
                            ...
                            <td>
                                ...
                                <div id="ttdWali">
                                    <?php if ($data->penerjemah["ttdWali"]) {
                                        ...
                                        echo '<img src="' . base_url('public/ttd/penerjemah/' . $data->penerjemah["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                    } else {
                                        echo '<br><br><br><br><br>';
                                    } ?>
                                </div>
                                <br>
                                (<?= $data->penerjemah["nama"] ?> )
                                <br><br>
                                <?php if (!$data->penerjemah["ttdWali"]) { ?>
                    ...
                    <input type="hidden" id="noRawat" value="<?= $data->penerjemah["noRawat"] ?>">
                    <input type="hidden" id="petugas" value="<?= $data->penerjemah["petugas"] ?>">
                    <div class="row mt-2">
                        <div class="col-12 text-center">
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/penerjemah/simpanTtd',
            method: 'post',
            data: {
                noRawat: noRawat,
                ttdWali: ttdWali,
