                ...
                <table class="table table-bordered table-sm">
                    <tr class="text-center">
                        <th style="background-color: #eaeaea;" colspan="4">
                            <p style="font-size: 14pt; margin:0;" class="text-uppercase"><i><b>INFORMED CONCENT</b></i> <?= $data->icGeneral['judul'] ?></p>
                        </th>
                    </tr>
                    <tr class="text-center">
                        <th style="background-color: #eaeaea;" colspan="4">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><?= $data->icGeneral['nama'] ?></td>
                    </tr>
                    <tr class="text-center">
                        <th>No.</th>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%;">Diagnosis</td>
                        <td style="width: 85%;"><?= $data->icGeneral['diagnosis'] ?></td>
                        <td class="text-center text-success fw-bold" style="width: 5%; font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">2</td>
                        <td>Dasar diagnosis</td>
                        <td><?= $data->icGeneral['dasar'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">3</td>
                        <td>Tindakan kedokteran</td>
                        <td><?= $data->icGeneral['tindakan'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">4</td>
                        <td>Indikasi tindakan</td>
                        <td><?= $data->icGeneral['indikasi'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">5</td>
                        <td>Tata cara</td>
                        <td><?= $data->icGeneral['tataCara'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">6</td>
                        <td>Tujuan</td>
                        <td><?= $data->icGeneral['tujuan'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">7</td>
                        <td>Risiko</td>
                        <td><?= $data->icGeneral['risiko'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">8</td>
                        <td>Komplikasi</td>
                        <td><?= $data->icGeneral['komplikasi'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">9</td>
                        <td>Prognosis</td>
                        <td><?= $data->icGeneral['prognosis'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">10</td>
                        <td>Alternatif</td>
                        <td><?= $data->icGeneral['alternatif'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    <tr>
                        <td class="text-center">11</td>
                        <td>Lain-lain</td>
                        <td><?= $data->icGeneral['lainLain'] ?></td>
                        <td class="text-center text-success fw-bold" style="font-size: 1.2rem;">✔</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="vertical-align: top; font-size: 0.9rem;">
                            ...
                            <div class="text-muted" style="font-size: 7pt;">( <?= $data->icGeneral['dokter'] ? $data->icGeneral['dokter'] : '............................' ?> )</div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" class="p-1" style="vertical-align: top; height: 100px;">
                        ...
                        <td class="text-center" style="vertical-align: top; font-size: 0.9rem;">
                            ...
                            <?php if ($data->icGeneral["ttdWali"]) {
                                // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                echo '<img src="' . base_url('public/ttd/icGeneral/' . $data->icGeneral["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 50px;" data-is-new="false">';
                            } else {
                                echo '<br><br>';
                            } ?>
                            <div class="text-muted" style="font-size: 7pt;">( <?= $data->icGeneral['nama'] ? $data->icGeneral['nama'] : '............................' ?> )</div>
                        </td>
                    </tr>

                    <tr>
                        <td colspan="4" class="p-2 bg-light">
                            <small class="fst-italic">* Bila pasien tidak kompeten atau tidak mau menerima informasi, maka penerima informasi adalah wali atau keluarga terdekat.</small>
                        </td>
                    </tr>
                </table>
                ...
                <div class="container my-4 text-dark" style="max-width: 800px; font-family: 'Times New Roman', Times, serif; line-height: 1.6;">
                    <div class="card p-5 border-dark shadow-sm">
                        ...
                        <div class="text-center mb-1">
                            <p style="font-size: 14pt;"><b><?= $data->icGeneral['jenis'] ==  'setuju' ? 'PERSETUJUAN' : 'PENOLAKAN' ?> TINDAKAN KEDOKTERAN</b></p>
                        </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-8 d-flex align-items-center">
                                    <span class="me-2">:</span>
                                    <?= $data->icGeneral["tempatLahir"] . ", " . $tglLahir->format('d-m-Y')  ?></td>
                                    <span class="ms-3">/ <?= $data->icGeneral["jk"] == "L" ? 'LAKI - LAKI' : ' PEREMPUAN' ?></span>
                                </div>
                            </div>
                        ...
                        <div class="text-center mb-1">
                            <p style="font-size: 14pt;"><b><?= $data->icGeneral['jenis'] ==  'setuju' ? 'PERSETUJUAN' : 'PENOLAKAN' ?></b></p>
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="row mb-1">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <?= $data->icGeneral['tindakanMedis'] ?>
                                </div>
                            </div>

                            <p class="mb-3 fw-bold">Terhadap : <?= $data->icGeneral['sebagai'] ?></p>
                        ...
                        <div class="mb-1 text-justify" style="text-align: justify;">
                            <p class="mb-1"><?= $data->icGeneral['jenis'] ==  'setuju' ? 'Saya memahami perlunya tindakan medis tersebut diatas, serta risiko yang dapat ditimbulkan telah cukup dijelaskan oleh dokter dan telah saya mengerti sepenuhnya. Saya juga menyadari bahwa oleh karena ilmu kedokteran bukanlah ilmu pasti, maka keberhasilan tindakan kedokteran bukanlah keniscayaan, melainkan sangat tergantung kepada izin Tuhan Yang Maha Esa.' : 'Yang tujuan, sifat dan perlunya tindakan medis tersebut diatas, serta resiko yang dapat ditimbulkan telah cukup dijelaskan oleh dokter dan telah saya mengerti sepenuhnya' ?></p>
                            <p>Demikian pernyataan ini saya buat dengan penuh kesadaran dan tanpa paksaan.</p>
                        </div>

                        <div class="row text-center mt-1">
                            <div class="col-12 text-end">
                                Bangkalan, <?= $data->icGeneral['tglTtd'] ?>
                            </div>
                            <table class="table table-borderless">
                                <tr class="text-center" style="margin:auto;">
                                    <td>
                                        ...
                                        <br>
                                        (<?= $data->icGeneral["dokter"] ?> )
                                    </td>
                                    <td>
                                        Saksi
                                        <br><br>
                                        <div id="ttdSaksi">
                                            <?php if ($data->icGeneral["ttdSaksi"]) {
                                                // SOLUSI: Menggunakan base_url() murni yang digabung dengan string path
                                                $urlSaksi = base_url() . 'public/ttd/icGeneral/' . $data->icGeneral["ttdSaksi"];
                                    ...
                                    <td>
                                        ...
                                        <div id="ttdWali">
                                            <?php if ($data->icGeneral["ttdWali"]) {
                                                // Sudah ditambahkan 'public/' agar gambar tidak broken/silang
                                                echo '<img src="' . base_url('public/ttd/icGeneral/' . $data->icGeneral["ttdWali"]) . '" alt="tanda tangan Wali" style="max-width: 150px;" data-is-new="false">';
                                            } else {
                                                echo '<br><br><br><br><br>';
                                            } ?>
                                        </div>
                            ...
                            <input type="hidden" id="id" value="<?= $data->icGeneral["id"] ?>">
                            <input type="hidden" id="dokter" value="<?= $data->icGeneral["dokter"] ?>">
                            <div class="row mt-5">
                                <div class="col-12 text-center">
                                    <div class="" id="pesanError"></div>
                                    <?php if (!$data->icGeneral["ttdWali"] and !$data->icGeneral["ttdSaksi"]) { ?>
...
<script>
    function kunciTtd() {
        ...
        $.ajax({
            url: '<?= base_url() ?>rm/icGeneral/simpanTtd',
            method: 'post',
            data: {
                id: id,
                ttdSaksi: ttdSaksi,
    ...
    qrcode.makeCode("Di ttd oleh " + $("#dokter").val() + " untuk Informed concent. No Rawat : " + $("#id").val()); // Replace with your desired text or URL
    qrKecil.makeCode("Di ttd oleh " + $("#dokter").val() + " untuk Informed concent. No Rawat : " + $("#id").val()); // Replace with your desired text or URL
