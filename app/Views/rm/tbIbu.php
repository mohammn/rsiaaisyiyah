    ...
    <div class="card mb-4">
        ...
        <div class="card-body" style="overflow-y: auto;">
            <div class="text-center">
                <h5 class="text-uppercase">FORMULIR SKRINING TBC UNTUK USIA &ge; 15 TAHUN</h5>
                ...
                <div class="row">
                        ...
                        <div class="alert alert-info">
                            ...
                            <table class="table table-info table-borderless">
                                <tr>
                                    ...
                                    <td>: <?= $data->tbIbu["tglSkrining"] ?? '-'  ?></td>
                                </tr>
                                <tr>
                                    <td>Tempat Skringin</td>
                                    <td>: <?= $data->tbIbu["tempatSkrining"] ?? '-' ?></td>
                                </tr>
                                <tr>
                                    <td>Berat Badan :</td>
                                    <td>: <?= $data->tbIbu["beratBadan"] ?? '-' ?></td>
                                </tr>
                                <tr>
                                    <td>Tinggi Badan :</td>
                                    <td>: <?= $data->tbIbu["tinggiBadan"] ?? '-' ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="alert alert-info">
                            ...
                            <table class="table table-info table-borderless">
                                <tr>
                                    <td>Kontak TBC :</td>
                                    <td>: <?= $data->tbIbu["kontakTbc"] ?? '-' ?></td>
                                </tr>
                                <tr>
                                    <td>Terduga TBC</td>
                                    <td>: <?= $data->tbIbu["terduga"] ?? '-' ?></td>
                                </tr>
                                <tr>
                                    <td>Kesimpulan Radiografi Toraks</td>
                                    <td>: <?= $data->tbIbu["kesimpulan"] ?? '-' ?></td>
                                </tr>
                                <tr>
                                    <td>Petugas</td>
                                    <td>: <?= $data->tbIbu["petugas"] ?? '-' ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <?php if ($data->tbIbu['ttdWali']): ?>
                            <a class="btn btn-estetik btn-cetak" href="<?= base_url('/rm/tbIbu/cetak/' . str_replace('/', '-', $data->pasien['no_rawat']) . '/' . $data->tbIbu['id']) ?>" target="_blank">
                                <i class="fas fa-print me-1"></i> Cetak
                            </a>
                        <?php else: ?>
                            <a class="btn btn-estetik btn-simpan" href="<?= base_url('/rm/tbIbu/cetak/' . str_replace('/', '-', $data->pasien['no_rawat']) . '/' . $data->tbIbu['id']) ?>" target="_blank">
            ...
            <?php else : ?>
                ...
                <?= $this->include("rm/partials/formTbIbu.php") ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-estetik btn-simpan" onclick="simpan(<?= $data->tbIbu['id'] ?? '' ?>)">
...
<script>
    ...
    <?php if ($data->tbIbu) : ?>
        ...
        function hapus() {
            var noRawat = "<?= $data->tbIbu['noRawat'] ?? '' ?>";

            $.ajax({
                url: '<?= base_url() ?>rm/tbIbu/hapus',
                method: 'post',
        ...
        function ubahWaktu() {
            waktu = $("#waktu").val();
            noRawat = "<?= $data->tbIbu['noRawat'] ?? '' ?>";

            $.ajax({
                url: '<?= base_url() ?>rm/tbIbu/ubahWaktu',
                method: 'post',
                data: {
