                ...
                <tbody id="tabelDataRm">
                    ...
                    <?php if ($data->rm4PermintaanMasuk) : ?>
                        <tr>
                            ...
                            <td><?= !empty($data->rm4PermintaanMasuk['ttdWali']) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                            <td>
