                ...
                <tbody id="tabelDataRm">
                    ...
                    <?php if ($data->rm11b1Checklist) : ?>
                        <tr>
                            ...
                            <td><?= (!empty($data->rm11b1Checklist['perawatAnestesi']) && !empty($data->rm11b1Checklist['dokterAnestesi']) && !empty($data->rm11b1Checklist['sirkuler']) && !empty($data->rm11b1Checklist['instrumen']) && !empty($data->rm11b1Checklist['asisten']) && !empty($data->rm11b1Checklist['operator']) && !empty($data->rm11b1Checklist['drAnestesi'])) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                            <td>
                                <a href="<?= base_url(" rm/rm11b1Checklist/" . str_replace('/', '-', $data->pasien["no_rawat"])) ?>" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-purple"><i class="fas fa-search"></i> Lihat</a>
                                <?= (!empty($data->rm11b1Checklist['perawatAnestesi']) && !empty($data->rm11b1Checklist['dokterAnestesi']) && !empty($data->rm11b1Checklist['sirkuler']) && !empty($data->rm11b1Checklist['instrumen']) && !empty($data->rm11b1Checklist['asisten']) && !empty($data->rm11b1Checklist['operator']) && !empty($data->rm11b1Checklist['drAnestesi'])) ? ' <a href="' . base_url('/rm/rm11b1Checklist/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-teal"><i class="fas fa-print"></i> Cetak</a>' : ' <a href="' . base_url('/rm/rm11b1Checklist/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-blue"><i class="fas fa-pen-nib"></i> TTD</a>' ?>
                    ...
                    <?php if ($data->rm11a2Timbang) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?= !empty($data->rm11a2Timbang['pengantar']) && !empty($data->rm11a2Timbang['penerima']) && !empty($data->rm11a2Timbang['pengantar2']) && !empty($data->rm11a2Timbang['penerima2']) ? '<a href="' . base_url('/rm/rm11a2Timbang/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-teal"><i class="fas fa-print"></i> Cetak</a>' : '<a href="' . base_url('/rm/rm11a2Timbang/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-blue"><i class="fas fa-pen-nib"></i> TTD</a>' ?>
                    ...
                    <?php if ($data->skorPoudji): ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge-estetik <?= $data->status["skorPoudji"][$i][0] === 'Lengkap' ? 'bg-vibrant-teal' : 'bg-vibrant-red' ?>"
                                        title="<?= htmlspecialchars(implode(', ', $data->status["skorPoudji"][$i][1])) ?>">
                                        <?= $data->status["skorPoudji"][$i][0] ?>
                                    </span>
                                </td>
                                <td>
                    ...
                    <?php if ($data->rm20bUdds) : ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge-estetik <?= $data->status["rm20bUdds"][0] === 'Lengkap' ? 'bg-vibrant-teal' : 'bg-vibrant-red' ?>"
                                    title="<?= htmlspecialchars(implode(', ', $data->status["rm20bUdds"][1])) ?>">
                                    <?= $data->status["rm20bUdds"][0] ?>
                                </span>
                            </td>
                    ...
                    <?php if ($data->rm26bRujukKeluar) : ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge-estetik <?= $data->status["rm26bRujukKeluar"][0] === 'Lengkap' ? 'bg-vibrant-teal' : 'bg-vibrant-red' ?>"
                                    title="<?= htmlspecialchars(implode(', ', $data->status["rm26bRujukKeluar"][1])) ?>">
                                    <?= $data->status["rm26bRujukKeluar"][0] ?>
                                </span>
                            </td>
                            <td><?= !empty($data->rm26bRujukKeluar['dokter']) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                            <td>
                                <a href="<?= base_url(" rm/rm26bRujukKeluar/" . str_replace('/', '-', $data->pasien["no_rawat"])) ?>" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-purple"><i class="fas fa-search"></i> Lihat</a>
                                <?= !empty($data->rm26bRujukKeluar['dokter']) ? '<a href="' . base_url('/rm/rm26bRujukKeluar/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-teal"><i class="fas fa-print"></i> Cetak</a>' : '<a href="' . base_url('/rm/rm26bRujukKeluar/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-blue"><i class="fas fa-pen-nib"></i> TTD</a>' ?>
                                <a href="<?= base_url('/rm/rm26bRujukKeluar/' . str_replace('/', '-', $data->pasien['no_rawat']))  ?>#modalHapus" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-red"><i class="fas fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <?php if ($data->penerjemah) : ?>
                        <tr>
                            <td>Permintaan Penerjemah</td>
                            <td>
                                <span class="badge-estetik <?= $data->status["penerjemah"][0] === 'Lengkap' ? 'bg-vibrant-teal' : 'bg-vibrant-red' ?>"
                                    title="<?= htmlspecialchars(implode(', ', $data->status["penerjemah"][1])) ?>">
                                    <?= $data->status["penerjemah"][0] ?>
                                </span>
                            </td>
                            <td><?= !empty($data->penerjemah['ttdWali']) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                            <td>
                                <a href="<?= base_url(" rm/penerjemah/" . str_replace('/', '-', $data->pasien["no_rawat"])) ?>" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-purple"><i class="fas fa-search"></i> Lihat</a>
                                <?= !empty($data->penerjemah['ttdWali']) ? '<a href="' . base_url('/rm/penerjemah/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-teal"><i class="fas fa-print"></i> Cetak</a>' : '<a href="' . base_url('/rm/penerjemah/cetak/' . str_replace('/', '-', $data->pasien['no_rawat'])) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-blue"><i class="fas fa-pen-nib"></i> TTD</a>' ?>
                                <a href="<?= base_url('/rm/penerjemah/' . str_replace('/', '-', $data->pasien['no_rawat']))  ?>#modalHapus" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-red"><i class="fas fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <?php if ($data->rm9aTransferPasien) : ?>
                        <?php for ($i = 0; $i < count($data->rm9aTransferPasien); $i++) : ?>
                            <tr>
                                <td>Transfer Pasien antar Unit Layanan (<?= $data->rm9aTransferPasien[$i]['judul'] ?>)</td>
                                <td>
                                    <span class="badge-estetik <?= $data->status["rm9aTransferPasien"][$i][0] === 'Lengkap' ? 'bg-vibrant-teal' : 'bg-vibrant-red' ?>"
                                        title="<?= htmlspecialchars(implode(', ', $data->status["rm9aTransferPasien"][$i][1])) ?>">
                                        <?= $data->status["rm9aTransferPasien"][$i][0] ?>
                                    </span>
                                </td>
                                <td><?= !empty($data->rm9aTransferPasien[$i]['petugasMenyerahkan']) && !empty($data->rm9aTransferPasien[$i]['petugasMenerima']) ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<span class="badge-estetik bg-vibrant-red">Belum</span>' ?></td>
                                <td>
                                    <a href="<?= base_url(" rm/rm9aTransferPasien/" . str_replace('/', '-', $data->pasien["no_rawat"])) . "/" . $data->rm9aTransferPasien[$i]["id"] ?>" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-purple"><i class="fas fa-search"></i> Lihat</a>
                                    <?= !empty($data->rm9aTransferPasien[$i]['petugasMenyerahkan']) && !empty($data->rm9aTransferPasien[$i]['petugasMenerima']) ? '<a href="' . base_url('/rm/rm9aTransferPasien/cetak/' . str_replace('/', '-', $data->pasien['no_rawat']) . "/" . $data->rm9aTransferPasien[$i]["id"]) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-teal"><i class="fas fa-print"></i> Cetak</a>' : '<a href="' . base_url('/rm/rm9aTransferPasien/cetak/' . str_replace('/', '-', $data->pasien['no_rawat']) . "/" . $data->rm9aTransferPasien[$i]["id"]) . '" target="_blank" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-blue"><i class="fas fa-pen-nib"></i> TTD</a>' ?>
                                    <a href="<?= base_url('/rm/rm9aTransferPasien/' . str_replace('/', '-', $data->pasien['no_rawat'])) . "/" . $data->rm9aTransferPasien[$i]["id"]  ?>#modalHapus" style="text-decoration: none;" class="btn-estetik btn-sm-estetik bg-vibrant-red"><i class="fas fa-trash"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    <?php endif; ?>
                ...
                <table class="table table-striped table-responsive-lg" id="tabelForm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Surat Permintaan Masuk Rumah Sakit</td>
                            <td>
                                <?= $data->rm4PermintaanMasuk ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/rm4PermintaanMasuk/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>26.</td>
                        ...
                        <tr>
                            ...
                            <td>Checklist Keselamatan di Kamar Bedah</td>
                            <td>
                                <?= $data->rm11b1Checklist ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/rm11b1Checklist/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>29.</td>
                            <td>Penandaan Lokasi Operasi</td>
                            <td>
                                <?= $data->rm11a1Bedah ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/rm11a1Bedah/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>30.</td>
                            <td>Timbang Terima Untuk Keselamatan Pembedahan</td>
                            <td>
                                <?= $data->rm11a2Timbang ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/rm11a2Timbang/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>31.</td>
                            <td>Permintaan Penerjemah</td>
                            <td>
                                <?= $data->penerjemah ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/penerjemah/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>32.</td>
                            <td>Formulir Skrining dari Luar Rumah Sakit</td>
                            <td>
                                <?= $data->rm26jRujukanLuar ? '<span class="badge-estetik bg-vibrant-teal">Sudah</span>' : '<a href="' . base_url("rm/rm26jRujukanLuar/" . str_replace('/', '-', $data->pasien["no_rawat"])) . '" class="btn-estetik btn-sm-estetik bg-vibrant-blue"  style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>' ?>
                            </td>
                        </tr>
                        <tr>
                            <td>33.</td>
                            <td>Transfer pasien antar unit layanan</td>
                            <td>
                                <a href="<?= base_url("rm/rm9aTransferPasien/" . str_replace('/', '-', $data->pasien["no_rawat"]) . "/0")  ?>" class="btn-estetik btn-sm-estetik bg-vibrant-blue" style="text-decoration: none;"><i class="fas fa-plus"></i> Tambah</a>
                            </td>
                        </tr>
                        <tr>
                            <td>34.</td>
