...
class TbAnak extends BaseController
{
    ...
    public function index($noRawat)
    {
        ...
        return view('rm/tbAnak', ['data' => $data]);
    }
    ...
    public function simpan()
    {
        ...
        if ($this->request->getPost("tujuanSimpan") == 'tambah') {
            $this->tbAnakModel->save($data);
            $this->catatLog('tambah', 'tb_anak', $this->request->getPost("noRawat"), $this->tbAnakModel->where('noRawat', $this->request->getPost("noRawat"))->first());
        } else {
            $noRawat = $this->request->getPost("noRawat");
            unset($data['noRawat']);

            $this->catatLog('ubah', 'tb_anak', $noRawat, $this->tbAnakModel->where('noRawat', $noRawat)->first(), $data);

            $this->tbAnakModel->where('noRawat', $noRawat)->set($data)->update();
        }
    ...
    public function hapus()
    {
        $noRawat = $this->request->getPost("noRawat");
        $noRawat = str_replace('-', '/', $noRawat);
        $this->catatLog('hapus', 'ic_darah', $noRawat, $this->tbAnakModel->where('noRawat', $noRawat)->first());

        $this->tbAnakModel->where("noRawat", $noRawat)->delete();
        echo json_encode("");
    }
    ...
    public function cetak($noRawat)
    {
        ...
        echo view("cetak/tbAnak", ["data" => $data]);
